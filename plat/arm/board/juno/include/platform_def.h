...
#define PLAT_ARM_G1S_IRQ_PROPS(grp) \
	...
	INTR_PROP_DESC(JUNO_IRQ_ETR_SMMU, GIC_HIGHEST_SEC_PRIORITY, \
		(grp), GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(JUNO_IRQ_PMI, GIC_HIGHEST_SEC_PRIORITY,             \
		(grp), GIC_INTR_CFG_LEVEL),                         \
	INTR_PROP_DESC(JUNO_IRQ_PMI_2, GIC_HIGHEST_SEC_PRIORITY,           \
		(grp), GIC_INTR_CFG_LEVEL),                         \
	INTR_PROP_DESC(JUNO_IRQ_PMI_3, GIC_HIGHEST_SEC_PRIORITY,           \
		(grp), GIC_INTR_CFG_LEVEL),                         \
	INTR_PROP_DESC(JUNO_IRQ_PMI_4, GIC_HIGHEST_SEC_PRIORITY,           \
		(grp), GIC_INTR_CFG_LEVEL),                         \
	INTR_PROP_DESC(JUNO_IRQ_PMI_5, GIC_HIGHEST_SEC_PRIORITY,           \
		(grp), GIC_INTR_CFG_LEVEL),                         \
	INTR_PROP_DESC(JUNO_IRQ_PMI_6, GIC_HIGHEST_SEC_PRIORITY,           \
		(grp), GIC_INTR_CFG_LEVEL)
